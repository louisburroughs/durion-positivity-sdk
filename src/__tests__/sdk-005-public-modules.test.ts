...
const PHASE_2_MODULES = [
  ...
  ['people-contact', 'createPeopleContactClient'],
  ['marketing', 'createMarketingClient'],
  ['mcp-server', 'createMcpServerClient'],
  ['supplier', 'createSupplierClient'],
  ['warranty', 'createWarrantyClient'],
...
const PHASE_2_API_PROPS: Readonly<Record<string, readonly string[]>> = {
  ...
  'people': ['employeeApi', 'peopleStaffingAssignmentsApi'],
