...
- `LocationBootstrap` must resolve one location with code `ATX-RIV-001` (reusing the pack row when present or creating it otherwise) and three bays with the exact names and bay types in the plan.
