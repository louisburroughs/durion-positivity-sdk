 ...
 */
export function instanceOfWorkorderStatusHistoryEntry(value: object): boolean {
    return true;
}

export function WorkorderStatusHistoryEntryFromJSON(json: any): WorkorderStatusHistoryEntry {
    return WorkorderStatusHistoryEntryFromJSONTyped(json, false);
}

export function WorkorderStatusHistoryEntryFromJSONTyped(json: any, ignoreDiscriminator: boolean): WorkorderStatusHistoryEntry {
    if (json == null) {
        return json;
    }
    return {
...
export function WorkorderStatusHistoryEntryToJSON(value?: WorkorderStatusHistoryEntry | null): any {
    if (value == null) {
        return value;
    }
    return {
