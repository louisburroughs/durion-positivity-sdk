...
class WorkorderDetailApi extends runtime.BaseAPI {
     ...
     */
    getWorkorderDetailRaw(requestParameters, initOverrides) {
     ...
     * Get workorder detail with role-based visibility
     */
    getWorkorderDetail(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getWorkorderDetailRaw(requestParameters, initOverrides);
