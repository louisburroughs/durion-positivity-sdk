...
exports.instanceOfUpdateStaffingAssignmentRequest = instanceOfUpdateStaffingAssignmentRequest;
exports.UpdateStaffingAssignmentRequestFromJSON = UpdateStaffingAssignmentRequestFromJSON;
exports.UpdateStaffingAssignmentRequestFromJSONTyped = UpdateStaffingAssignmentRequestFromJSONTyped;
exports.UpdateStaffingAssignmentRequestToJSON = UpdateStaffingAssignmentRequestToJSON;
/**
...
function UpdateStaffingAssignmentRequestFromJSON(json) {
    return UpdateStaffingAssignmentRequestFromJSONTyped(json, false);
}
function UpdateStaffingAssignmentRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function UpdateStaffingAssignmentRequestToJSON(value) {
    if (value == null) {
        return value;
    }
    return {
