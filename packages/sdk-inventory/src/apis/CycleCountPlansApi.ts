...
import type {
  ...
  GenerateCycleCountTasksRequest,
...
import {
    ...
    CycleCountTaskGenerationResponseFromJSON,
    CycleCountTaskGenerationResponseToJSON,
    CycleCountTaskResponseFromJSON,
    CycleCountTaskResponseToJSON,
    GenerateCycleCountTasksRequestFromJSON,
    GenerateCycleCountTasksRequestToJSON,
...
export interface GenerateCycleCountTasksOperationRequest {
    planId: string;
    generateCycleCountTasksRequest: GenerateCycleCountTasksRequest;
}
...
export interface ListCycleCountPlanTasksRequest {
    planId: string;
}
...
export class CycleCountPlansApi extends runtime.BaseAPI {
     ...
     */
    async generateCycleCountTasksRaw(requestParameters: GenerateCycleCountTasksOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CycleCountTaskGenerationResponse>> {
        if (requestParameters['planId'] == null) {
            throw new runtime.RequiredError(
                'planId',
                'Required parameter "planId" was null or undefined when calling generateCycleCountTasks().'
            );
        }

        if (requestParameters['generateCycleCountTasksRequest'] == null) {
            throw new runtime.RequiredError(
                'generateCycleCountTasksRequest',
                'Required parameter "generateCycleCountTasksRequest" was null or undefined when calling generateCycleCountTasks().'
            );
        }
        ...
        const response = await this.request({
            path: `/v1/inventory/cycleCountPlans/{planId}/tasks`.replace(`{${"planId"}}`, encodeURIComponent(String(requestParameters['planId']))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
            body: GenerateCycleCountTasksRequestToJSON(requestParameters['generateCycleCountTasksRequest']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => CycleCountTaskGenerationResponseFromJSON(jsonValue));
    }
     ...
     * Generate count tasks for a cycle count plan
     */
    async generateCycleCountTasks(requestParameters: GenerateCycleCountTasksOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CycleCountTaskGenerationResponse> {
        const response = await this.generateCycleCountTasksRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async listCycleCountPlanTasksRaw(requestParameters: ListCycleCountPlanTasksRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<CycleCountTaskResponse>>> {
        if (requestParameters['planId'] == null) {
            throw new runtime.RequiredError(
                'planId',
                'Required parameter "planId" was null or undefined when calling listCycleCountPlanTasks().'
            );
        }
     ...
     * List a cycle count plan\'s tasks
     */
    async listCycleCountPlanTasks(requestParameters: ListCycleCountPlanTasksRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<CycleCountTaskResponse>> {
        const response = await this.listCycleCountPlanTasksRaw(requestParameters, initOverrides);
        return await response.value();
    }
