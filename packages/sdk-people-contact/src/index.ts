...
export function createPeopleContactClient(config: DurionSdkConfig) {
  ...
  return {
    ...
    postalAddressApi: new GeneratedApis.PostalAddressAPIApi(configuration),
    userPersonLinkingApi: new GeneratedApis.UserPersonLinkingAPIApi(configuration),
  };
}
...
// '@durion-sdk/people-contact'` has to keep working. The canonical definition now lives
// in one place.
