...
export function createInvoiceClient(config: DurionSdkConfig) {
  ...
  return {
    billingRulesApi: new GeneratedApis.BillingRulesApi(configuration),
    invoiceApi: new GeneratedApis.InvoiceApi(configuration),
  };
}
...
// '@durion-sdk/invoice'` has to keep working. The canonical definition now lives
// in one place.
